...
public class FamilyTreeTest {
	...
	public void testRelationshipAmongPeople() { //Exercise 3
		...
		assertEquals(people.get(bob).intValue(), familyTree.getLinkedPeople(familyTree.getPerson(bob)).size());
		assertEquals(people.get(jenny).intValue(), familyTree.getLinkedPeople(familyTree.getPerson(jenny)).size());
		assertEquals(people.get(nigel).intValue(), familyTree.getLinkedPeople(familyTree.getPerson(nigel)).size());
		assertEquals(people.get(alan).intValue(), familyTree.getLinkedPeople(familyTree.getPerson(alan)).size());
	}
